...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, pixels, geomBuffer, binningBuffer, imgBuffer, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, pixels, invdepths

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, _, grad_out_depth):
